...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\lucas\\OneDrive\\Documentos\\pass.in\\backend\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "generator client {\r\n  provider = \"prisma-client-js\"\r\n}\r\n\r\ndatasource db {\r\n  provider = \"sqlite\"\r\n  url      = env(\"DATABASE_URL\")\r\n}\r\n\r\nmodel Event {\r\n  id               String  @id @default(uuid())\r\n  title            String\r\n  details          String?\r\n  slug             String  @unique\r\n  maximumAttendees Int?    @map(\"maxinum_attendees\")\r\n\r\n  attendees Attendee[]\r\n\r\n  @@map(\"events\")\r\n}\r\n\r\nmodel Attendee {\r\n  id        Int      @id @default(autoincrement())\r\n  name      String\r\n  email     String\r\n  createdAt DateTime @default(now()) @map(\"created_at\")\r\n  eventId   String   @map(\"event_id\")\r\n\r\n  event   Event    @relation(fields: [eventId], references: [id], onDelete: Cascade)\r\n  checkIn CheckIn?\r\n\r\n  @@unique([eventId, email])\r\n  @@map(\"attendees\")\r\n}\r\n\r\nmodel CheckIn {\r\n  id        Int      @id @default(autoincrement())\r\n  createdAt DateTime @default(now()) @map(\"created_at\")\r\n\r\n  attendee   Attendee @relation(fields: [attendeeId], references: [id], onDelete: Cascade)\r\n  attendeeId Int      @unique @map(\"attendee_id\")\r\n\r\n  @@map(\"check_ins\")\r\n}\r\n",
  "inlineSchemaHash": "3ffb18c89a001e66ba1d6a3c999ebdf17a4dde61259e9baf35c63513a48b96d5",
  "copyEngine": true
}
